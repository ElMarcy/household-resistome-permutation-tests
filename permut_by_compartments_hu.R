...
# This script is identical to the other three block of compartment-based randomization scripts (patient/animal/environment/food), with the exception of the randomization section (lines 117-131), which randomizes only the Human compartment blocks 
...
for (i in 1:n_iter) {
  ...
  df_patient_random <- table_random %>% filter(sample_type == "Patient")     # 5. Take the patient df out
